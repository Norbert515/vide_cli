...
class ToastNotifier extends StateNotifier<ToastState> {
  ...
  void success(String message, {Duration? duration}) => show(ToastData(
        message: message,
  ...
  void error(String message, {Duration? duration}) => show(ToastData(
        message: message,
  ...
  /// Shows an info toast.
  void info(String message, {Duration? duration}) => show(ToastData(
        message: message,
        type: ToastType.info,
        duration: duration ?? const Duration(seconds: 3),
      ));
  ...
  void warning(String message, {Duration? duration}) => show(ToastData(
        message: message,
