...
///
/// Copied from [ConnectionNotifier].
@ProviderFor(ConnectionNotifier)
final connectionNotifierProvider =
    AutoDisposeNotifierProvider<ConnectionNotifier, ConnectionState>.internal(
...
typedef _$ConnectionNotifier = AutoDisposeNotifier<ConnectionState>;
