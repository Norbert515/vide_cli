...
class SyntheticMainGenerator {
  ...
  static Future<String> _getPackageName(String projectDir) async {
    ...
    print('📦 [SyntheticMainGenerator] Reading pubspec.yaml from: $pubspecPath');
    ...
    if (match == null) {
      print('❌ [SyntheticMainGenerator] Could not find package name in pubspec.yaml');
      throw Exception('Could not find package name in pubspec.yaml');
    }
    final packageName = match.group(1)!;
    print('📦 [SyntheticMainGenerator] Found package name: $packageName');
    return packageName;
  }
  ...
  static Future<String> generate({
    ...
    print('');
    print('🔧 [SyntheticMainGenerator] ========================================');
    print('🔧 [SyntheticMainGenerator] Generating synthetic main...');
    print('🔧 [SyntheticMainGenerator] Project directory: $projectDir');
    print('🔧 [SyntheticMainGenerator] User main path: $userMainPath');

    final dartToolDir = path.join(projectDir, '.dart_tool');
    final syntheticMainPath = path.join(dartToolDir, 'vide_debug_main.dart');
    print('🔧 [SyntheticMainGenerator] Synthetic main path: $syntheticMainPath');

    // Ensure .dart_tool directory exists
    await Directory(dartToolDir).create(recursive: true);
    print('🔧 [SyntheticMainGenerator] Created .dart_tool directory');
    ...
    print('🔧 [SyntheticMainGenerator] User main import: $userMainImport');
...
''';
    ...
    print('🔧 [SyntheticMainGenerator] ----------------------------------------');
    print('🔧 [SyntheticMainGenerator] Generated synthetic main content:');
    print('🔧 [SyntheticMainGenerator] ----------------------------------------');
    for (final line in syntheticMain.split('\n')) {
      print('🔧 [SyntheticMainGenerator]   $line');
    }
    print('🔧 [SyntheticMainGenerator] ----------------------------------------');
    print('🔧 [SyntheticMainGenerator] ========================================');
    print('');
  ...
  static Future<void> cleanup(String projectDir) async {
    final syntheticMainPath =
        path.join(projectDir, '.dart_tool', 'vide_debug_main.dart');
