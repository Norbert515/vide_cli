...
void main() {
  group('Trigger E2E Tests', () {
    ...
    test(
      'Status sync: AgentProcessingStatus changes should update AgentStatus',
      () async {
        ...
        subscription = mockClient.statusStream.listen((processingStatus) {
          final currentAgentStatus = container.read(
        ...
        expect(
          ...
          reason:
              'Status should still be working after completed (could be compaction)',
        );
