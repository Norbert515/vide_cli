...
final gitStatusWatcherProvider =
    Provider.family.autoDispose<GitStatusWatcher, String>((ref, repoPath) {
...
final gitStatusStreamProvider =
    StreamProvider.family.autoDispose<GitStatus, String>((ref, repoPath) {
