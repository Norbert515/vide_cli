...
///
/// Both [VideSession] (local) and [RemoteVideSession] need an identical
...
class SessionEventHub {
  ...
  ///
  /// Session implementations call [emit] rather than accessing this directly,
  /// but it is exposed for cases that need the raw stream (e.g. subscribing
  /// the ConversationStateManager before BufferedEventStream wrapping).
