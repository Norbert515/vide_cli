/// Public agent model for the VideCore API.
///
/// This provides a clean, immutable representation of an agent
...
///
/// This is the public representation of an agent in the network.
/// Use [VideSession.agents] to get the current list of agents.
class VideAgent {
