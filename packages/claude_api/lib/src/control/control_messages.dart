...
/// Initialize request to set up hooks
class InitializeRequest extends OutgoingControlRequest {
  InitializeRequest({
    required String requestId,
    required Map<String, List<Map<String, dynamic>>> hooks,
  }) : super(
    requestId: requestId,
    subtype: 'initialize',
    data: {'hooks': hooks},
...
/// Interrupt request to stop current execution
class InterruptRequest extends OutgoingControlRequest {
  InterruptRequest({required String requestId})
      : super(requestId: requestId, subtype: 'interrupt', data: {});
}

/// Set permission mode request
class SetPermissionModeRequest extends OutgoingControlRequest {
...
class RewindFilesRequest extends OutgoingControlRequest {
  RewindFilesRequest({
    required String requestId,
